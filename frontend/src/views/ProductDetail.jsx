...
const ProductDetail = () => {
    ...
    const handleSizeButtonClick = (e) => {
        e.preventDefault()
        const sizeValueInput = e.target.closest('.size_button').parentNode.querySelector(".size_name")
                        ...
                        <div>
                            ...
                            <div>
                                <div className="">
                                        ...
                                        <div className="d-flex">
                                            {size?.map((s, index) => (
                                                <div>
                                                    ...
                                                    <button key={index} type="button" onClick={handleSizeButtonClick} className="btn btn-secondary ms-2 size_button">{s.name}</button>
                                                </div>
                                            ))}
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-md-6 mb-4">
                                        <div className="">
                                            <h4>Color:{colorvalue}</h4>
                                            <div className="d-flex">
                                                {colors.map((color, index) => (
                                                    <div className="d-flex">
                                                        <input type="hidden" value={color.name} className="color_name" name="" />
                                                        <button className="btn p-3 m-1 color_button" type="button" onClick={handleColorButtonClick} style={{ backgroundColor: `${color.color_name}` }}></button>
                                                    </div>
                                                ))}
                                            </div>
